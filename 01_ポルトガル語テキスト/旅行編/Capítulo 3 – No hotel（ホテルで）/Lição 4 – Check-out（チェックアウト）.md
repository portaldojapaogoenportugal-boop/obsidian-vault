...
これまで学習してきた動詞の形は直説法現在形と呼ばれ、いわゆる現在を表す時制です。基本的に、習慣や恒常的事実を表すのに使われます。このほか、近い未来、確定的な予定を表す場合にも、現在形が使われます。会話例で、「後で戻ります」という未来の行為に、動詞voltarの直説法現在形**Volto**が使われているのは、そのためです。「後で（mais tarde）」という副詞がつくことで、近い未来、確定的な予定であることが分かります。
