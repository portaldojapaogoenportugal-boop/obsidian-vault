...
要望を伝えたい時は、ストレートにこの表現が便利です。会話例では、動詞と組み合わせて「～がしたい」という表現として紹介していますが、Quer＋名詞で、「～が欲しい」という表現にもなります。英語でいうと、wantに相当すると考えるといいでしょう。自分の要望を伝えるなら、一人称単数形queroを使います。主語によって動詞を活用することになります。
