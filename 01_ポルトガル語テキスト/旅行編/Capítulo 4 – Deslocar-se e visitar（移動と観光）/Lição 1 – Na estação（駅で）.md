...
シンプルに値段を言う場合は、ser動詞を使います。英語なら金額にかかわらず単数形（is）を使いますが、ポルトガル語では1ユーロでなければ複数形（são）を使うことになります。数字についてはANEXOをご参照ください。

| **ポルトガル語**            | **日本語**  |
| --------------------- | -------- |
| É um euros.           | 1ユーロです。  |
| São cem ienes.        | 100円です。  |
| São trinta dólares.   | 30ドルです。  |
| São cinquenta libras. | 50ポンドです。 |
...
ポルトガルの鉄道（comboio）では、切符は窓口や自動販売機で購入できます。

往復切符は「ida e volta」。

駅で「para onde?（どちらまで？）」と聞かれるのが定番。

オンライン購入やアプリ（CP – Comboios de Portugal）も一般的。
